        ...
        <>
            <div class="myAccountPop">
                <div class="Myaccount">
                    <div class="fd">
                        <div class="tabList">
                            <button class="tabbtn" id="PointTransfer">
                                Point Transfer</button>
                            <button class="tabbtnActive" id="Receivables">
                                Receivables</button>
                            <button class="tabbtn" id="Transferables">
                                Transferables</button>
                            <button class="tabbtn" id="ChangePwd">
                                Change Password</button>
                            <button class="tabbtn" id="ChangePin">
                                Change Pin</button>
                        ...
                        {/* <div class="tabContent fd">
                            <div class="inputTabs">
                                <div><img class="myAccImg" src="https://img.icons8.com/external-outline-black-m-oki-orlando/32/external-equivalent-math-vol-1-outline-outline-black-m-oki-orlando.png" />
                                </div>
